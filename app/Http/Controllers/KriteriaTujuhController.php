<?php
        ...
        public function index()
    {
        ...
        $page = (object)[
            'title' => 'Daftar Kriteria 7'
        ];    

        return view('kriteria7.index', compact('page', 'kriterias'));
    }
    ...
    return view('kriteria7.input', compact('page', 'kriteria'));
    }
...
if ($availableFinalisasi) {
    ...
    public function edit($id)
    {
        ...
        $page = (object) [
            'title' => 'Edit Kriteria 7 - PENELITIAN',
        ];
...
public function preview($id)
{
    ...
    try {
        return \PDF::loadView('kriteria7.export', ['details' => $detail])
 ...
 public function getPreviewData($id)
    {
        ...
        return response()->json([
            ...
            'catatan' => $catatan,
            'pdf_url' => route('kriteria7.preview', $id)
        ]);
    }   
