<?php
        ...
        public function index()
    {
        ...
        $page = (object)[
            'title' => 'Daftar Kriteria 6'
        ];    

        return view('kriteria6.index', compact('page', 'kriterias'));
    }
    ...
    return view('kriteria6.input', compact('page', 'kriteria'));
    }
...
if ($availableFinalisasi) {
    ...
    public function edit($id)
    {
        ...
        $page = (object) [
            'title' => 'Edit Kriteria 6 - PENDIDIKAN',
        ];
...
public function preview($id)
{
    ...
    try {
        return \PDF::loadView('kriteria6.export', ['details' => $detail])
    ...
    public function update(Request $request, $id)
{
     ...
     public function getPreviewData($id)
    {
        ...
        return response()->json([
            ...
            'catatan' => $catatan,
            'pdf_url' => route('kriteria6.preview', $id)
        ]);
    }   
