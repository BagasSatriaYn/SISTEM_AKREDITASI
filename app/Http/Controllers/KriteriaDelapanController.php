<?php
        ...
        public function index()
    {
        ...
        $page = (object)[
            'title' => 'Daftar Kriteria 8'
        ];    

        return view('kriteria8.index', compact('page', 'kriterias'));
    }
    ...
    return view('kriteria8.input', compact('page', 'kriteria'));
    }
   ...
   public function create()
{
    ...
    $breadcrumb = (object) [
        'title' => __('PENGABDIAN KEPADA MASYARAKAT'),
        'list' => __('PENGABDIAN KEPADA MASYARAKAT')
    ];
...
if ($availableFinalisasi) {
    ...
    public function edit($id)
    {
        ...
        $breadcrumb = (object) [
            'title' => 'Edit Kriteria Delapan',
            'list' => ['Kriteria', 'Kriteria8', 'Edit']
        ];

        $page = (object) [
            'title' => 'Edit Kriteria 8 - PENGABDIAN KEPADA MASYARAKAT',
        ];
...
public function preview($id)
{
    ...
    try {
        return \PDF::loadView('kriteria8.export', ['details' => $detail])
 ...
 public function getPreviewData($id)
    {
        ...
        return response()->json([
            ...
            'catatan' => $catatan,
            'pdf_url' => route('kriteria8.preview', $id)
        ]);
    }   
