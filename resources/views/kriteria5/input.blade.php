                ...
                <div class="card mb-4">
                    ...
                    <form id="formPPEPP" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           @php
                                $k5 = $kriteria->firstWhere('id_kriteria', 5);
                            @endphp

                            <select class="form-control" disabled>
                                <option selected>{{ $k5->nama ?? 'Kriteria 5' }}</option>
                            </select>
                            <input type="hidden" name="id_kriteria" value="{{ $k5->id_kriteria ?? 5 }}">
                ...
                .then(data => {
                    if (data.status) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('kriteria5/index') }}";
                        });
                    } else {
