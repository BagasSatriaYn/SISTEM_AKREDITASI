...
<body class="g-sidenav-show   bg-gray-100">
  ...
  @include('layout.sidebardirektur')
  ...
  <div class="card">
    <div class="box-header">
      <h3 class="title">Validasi Data Kriteria Tahap 2</h3>
    </div>
  <div class="box-content">
    <div class="box-informasi">
          <div class="informasi">
            ...
            Berikut daftar data kriteria yang akan divalidasi pada <strong>tahap 2</strong>.<br>
            Mohon Validator agar melakukan validasi terhadap data yang telah tervalidasi tahap 1 dengan teliti.</center>
          </div>
        </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="statusDiterima">
                  Pengajuan Tahap 2 diterima <i class="fas fa-check-circle text-success me-1"></i>
                </label>
              </div>
              <div class="form-check">
                ...
                <label class="form-check-label" for="statusDitolak">
                  Pengajuan Tahap 2 ditolak <i class="fas fa-times-circle text-danger me-1"></i>
                </label>
              </div>
