                ...
                <div class="card mb-4">
                    ...
                    <form id="formPPEPP" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            @php
                                $k9 = $kriteria->firstWhere('id_kriteria', 9    );
                            @endphp

                            <select class="form-control" disabled>
                                <option selected>{{ $k9->nama ?? 'Kriteria 9    ' }}</option>
                            </select>
                            <input type="hidden" name="id_kriteria" value="{{ $k9->id_kriteria ?? 9  }}">
                ...
                .then(data => {
                    if (data.status) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('kriteria9/index') }}";
                        });
                    } else {
