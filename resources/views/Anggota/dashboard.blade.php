...
<body>
     <div class="login-alert" id="loginAlert">
            <span>Selamat datang <strong>Admin Kriteria 1!</strong> Anda bisa mengoperasikan sistem dengan wewenang tertentu melalui pilihan menu di bawah.</span>
    ...
    <div class="row g-3">
        <div class="col-6 col-sm-4 col-md-3">
            <div class="card text-center shadow-sm">
                <div class="card-body">
                    <img src="{{ asset('argon/assets/img/foto-menu.png') }}" alt="Input Data" class="img-fluid mb-2" style="max-height: 120px;">
        ...
        <div class="col-6 col-sm-4 col-md-3">
            <div class="card text-center shadow-sm">
                <div class="card-body">
                    <img src="{{ asset('argon/assets/img/foto-menu.png') }}" alt="Lihat Data" class="img-fluid mb-2" style="max-height: 120px;">
