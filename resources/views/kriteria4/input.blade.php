                ...
                <div class="card mb-4">
                    ...
                    <form id="formPPEPP" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            @php
                                $k4 = $kriteria->firstWhere('id_kriteria', 4);
                            @endphp

                            <select class="form-control" disabled>
                                <option selected>{{ $k4->nama ?? 'Kriteria 4' }}</option>
                            </select>
                            <input type="hidden" name="id_kriteria" value="{{ $k4->id_kriteria ?? 4 }}">
                ...
                .then(data => {
                    if (data.status) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('kriteria4/index') }}";
                        });
                    } else {
