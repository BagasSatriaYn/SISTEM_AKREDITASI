    ...
    <div class="header-content">
        <nav aria-label="breadcrumb" class="header-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Dashboard Direktur</li>
            </ol>
            <h5 class="mb-0" style="font-size: 1.1rem; color: white;">Dashboard Direktur</h5>
        </nav>
...
<div class="main-content">
    ...
    <div class="menu-cards d-flex flex-wrap gap-3">
    <a href="{{ route('validasi2') }}" class="menu-card kriteria-card flex-fill" style="min-width: 250px;">
        ...
        <div class="menu-card-title">
            ...
            <p class="text-muted mt-2 mb-0" style="font-size: 0.85rem;">Kelola kriteria penilaian dan parameter akreditasi Tahap 2</p>
        </div>
    </a>

   <a href="{{ route('direktur.finalisasi.index') }}" class="menu-card kriteria-card flex-fill" style="min-width: 250px;">
