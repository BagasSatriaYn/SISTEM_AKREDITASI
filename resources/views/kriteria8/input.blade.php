                ...
                <div class="card mb-4">
                    ...
                    <form id="formPPEPP" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           @php
                                $k8 = $kriteria->firstWhere('id_kriteria', 8);
                            @endphp

                            <select class="form-control" disabled>
                                <option selected>{{ $k8->nama ?? 'Kriteria 8' }}</option>
                            </select>
                            <input type="hidden" name="id_kriteria" value="{{ $k8->id_kriteria ?? 8 }}">
                ...
                .then(data => {
                    if (data.status) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('kriteria8/index') }}";
                        });
                    } else {
