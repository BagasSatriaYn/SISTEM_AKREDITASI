                ...
                <div class="card mb-4">
                    ...
                    <form id="formPPEPP" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           @php
                                $k7 = $kriteria->firstWhere('id_kriteria', 7);
                            @endphp

                            <select class="form-control" disabled>
                                <option selected>{{ $k7->nama ?? 'Kriteria 7' }}</option>
                            </select>
                            <input type="hidden" name="id_kriteria" value="{{ $k7->id_kriteria ?? 7 }}">
                ...
                .then(data => {
                    if (data.status) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('kriteria7/index') }}";
                        });
                    } else {
