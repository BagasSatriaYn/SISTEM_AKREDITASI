                ...
                <div class="card mb-4">
                    ...
                    <form id="formPPEPP" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           @php
                                $k6 = $kriteria->firstWhere('id_kriteria', 6);
                            @endphp

                            <select class="form-control" disabled>
                                <option selected>{{ $k6->nama ?? 'Kriteria 6' }}</option>
                            </select>
                            <input type="hidden" name="id_kriteria" value="{{ $k6->id_kriteria ?? 6 }}">
                ...
                .then(data => {
                    if (data.status) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('kriteria6/index') }}";
                        });
                    } else {
